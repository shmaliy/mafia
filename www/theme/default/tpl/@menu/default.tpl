...
<?php foreach ($this->elements as $element): ?>
	<?php if ($this->i < count($this->elements)-1){ $style = ' style="border-bottom:1px solid #eee !important;"'; } else { $style = ''; } ?>
	<?php if (!empty($element['childs'])): ?>
	<li onmouseover="this.className='hover'" onmouseout="this.className='nohover'"<?php echo $style; ?>>
	<?php else: ?>
	<li<?php echo $style; ?>>
	<?php endif; ?>
