...
class club_photos
{
    public $_const = array(
        ...
        'ERROR_FILE_EXISTS' => 'Файл уже добавлен',
        ...
        'SUCESS_ADDING_ITEM' => 'Фотоальбом добавлен',
        'SUCESS_SAVING_ITEM' => 'Фотоальбом сохранен',
        'SUCESS_DELETE_ITEM' => 'Фотоальбом удален',
    );
